...
public class ShoutsViewer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shouts_viewer);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_shouts_viewer, menu);
        return true;
    }
    ...
    // Deleted Scene PlaceholderFragment

    // Deleted Stop PlaceholderFragment
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position)
            {
                ...
                case 2 :
                    tab3Events tab3 = new tab3Events();
                    return tab3;
